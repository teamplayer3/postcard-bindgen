...
pub fn gen_ser_des_classes() -> Tokens {
    quote!(
        ...
        class Deserializer{bytes;constructor(t){this.bytes=Array.from(t)}pop_next=()=>{let t=this.bytes.shift();if(void 0===t)throw "input buffer too small";return t};pop_n=t=>{let e=Array(t);for(let r=0;r<t;r++)e.push(this.bytes.shift());return e};get_uint8=()=>this.pop_next();try_take=t=>{let e=0,r=max_val(t);for(let i=0;i<varint_max(t);i++){let s=this.pop_next(),o=127&s;if(e|=o<<7*i,(128&s)==0){if(!(o>r))return e;throw "Bad Variant"}}};deserialize_bool=()=>{let t=this.pop_next();return void 0===t?void 0:t>0};deserialize_number=(t,e)=>{if(t===U8_BYTES)return this.get_uint8();if(t===U16_BYTES||t===U32_BYTES||t===U64_BYTES||t===U128_BYTES)return e?de_zig_zag_signed(this.try_take(U16_BYTES)):this.try_take(U16_BYTES);throw "byte count not supported"};deserialize_string=()=>{let t=this.pop_n(this.try_take(U32_BYTES));return String.fromCharCode(...t)};deserialize_array=t=>[...Array(this.try_take(U32_BYTES))].map(()=>t(this))}
        class Serializer{bytes=[];finish=()=>this.bytes;serialize_bool=t=>this.serialize_number(U8_BYTES,!1,t?1:0);serialize_number=(t,s,i)=>{if(t===U8_BYTES)this.bytes.push(i);else if(t===U16_BYTES||t===U32_BYTES||t===U64_BYTES||t===U128_BYTES){let e=s?this.varint(t,zig_zag(t,i)):this.varint(t,i);this.push_n(e)}else throw "byte count not supported"};serialize_string=t=>{this.push_n(this.varint(U32_BYTES,t.length));let s=Array(t.length);for(let i=0;i<t.length;i++)s.push(t.charCodeAt(i));this.push_n(s)};serialize_array=(t,s)=>{this.push_n(this.varint(U32_BYTES,s.length)),s.forEach(s=>t(this,s))};push_n=t=>{t.forEach(t=>this.bytes.push(t))};varint=(t,s)=>{let i=s,e=[];for(let h=0;h<varint_max(t);h++){if(e.push(255&i),i<128)return e;e[h]|=128,i>>=7}}}
    )
}
