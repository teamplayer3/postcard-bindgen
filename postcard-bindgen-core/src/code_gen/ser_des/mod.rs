...
pub fn gen_ser_des_classes() -> Tokens {
    quote!(
        ...
        class Deserializer {
            ...
            deserialize_array = (des, len) => [...Array(len != undefined ? len : this.try_take(U32_BYTES))].map(() => des(this))
        ...
        class Serializer {
            ...
            serialize_array = (ser, array, len) => { this.push_n(varint(U32_BYTES, len != undefined ? len : array.length)); array.forEach((v) => ser(this, v)) }
